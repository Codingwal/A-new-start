...
public class SubmeshSplitter : MonoBehaviour
{
    ...
    public void Create()
    {
        ...
        {
            Mesh mesh = MeshExtension.GetSubmesh(meshFilter.sharedMesh, i);
            AssetDatabase.CreateAsset(mesh, $"{filePath}{i}.asset");
        }
    }
}
#endif
